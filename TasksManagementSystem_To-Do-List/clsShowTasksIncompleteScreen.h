...
class clsShowTasksIncompleteScreen :protected clsScreen
{
private:
    ...
    {      
        string Title = "\t    Tasks Incomplete Screen\n";
        string SubTitle = "\t       (" + to_string(clsTasksManagement::TotalIncompleteTasks()) + ") Task(s).";
        ...
        if (clsTasksManagement::TotalIncompleteTasks() == 0)
...
public:
    static void ShowTasksIncompleteScreen()
    {
        system("cls");
        ShowTasksList();
    }
